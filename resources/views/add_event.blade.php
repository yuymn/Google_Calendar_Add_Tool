...
<html>
	...
	<body>
		<div class="container">
			...
			<main>
				<div class="my-3">
					<a class="btn btn-primary" href="{{url('/')}}" role="button">単イベント追加</a>
					<a class="btn btn-outline-primary" href="{{url('/multi')}}" role="button">複数イベント追加</a>
				</div>
                <form action="add-event" method="POST">
                    @csrf
                    <div class="oneEventMode">
                        <h5>【日時入力設定】</h5>
                        <div class="dateinputSettings mb-3 ml-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="allDayCheck" name="allDayCheck">
                        ...
                        <!--ここから増やす対象-->
                        <div class="oneEventInputArea mx-3">
                            <div class="mb-2">
                                <span class="input-label">日時＋イベント名</span>
                                <div class="ml-2 text-secondary"><span id="inputExample"></span></div>
                                {{-- <input type="text" name="oneEventDateInput" id="oneEventDateInput" placeholder="" class=""> --}}
                                <textarea rows="3" cols="30" name="oneEventDateInput" id="oneEventDateInput" placeholder=""></textarea>
                            </div>
                            <div id="calendarInputArea" class="ml-5">
                                <div><input id="datepicker" type="hidden"></div>
                            </div>
                            <span class="input-label">色</span><br>
                            <div class="oneEventDateInput">
                    ...
                    <div class="mt-2">
                        <button class="btn btn-outline-primary" name="execBtn" type="submit">登録</button>
